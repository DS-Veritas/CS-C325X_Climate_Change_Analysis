...
### Objectives
In this research, we examined some representative scientific evidence of climate change, and made an attempt to model and extrapolate the global mean temperature using various prediction models. in addition, the performance of each algoriths are compared and analyzed. 
